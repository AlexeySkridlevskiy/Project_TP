...
VALUES ('Егор', 'Яхимович', '18', 'zosh@gmail.com', '1234'),
...
VALUES ('Балтика 7', 'Baltic Beverages Holding', '1', '123'),
       ('Сваяк', 'Минский завод виноградных вин', '2', '12'),
       ('Советское', 'ОАО «Минский завод игристых вин»', '3', '1234'),
       ('Краймс', '19 Crimes', '4', '345'),
       ('Балтика 9', 'Baltic Beverages Holding', '1', '1000'),
       ('Стольградная', 'Минск Кристалл', '2', '20');
...
ALTER TABLE Marks
    ADD FOREIGN KEY (AlcoholID) REFERENCES Alcohol (ID);
ALTER TABLE Alcohol
    ADD FOREIGN KEY (TypeID) REFERENCES AlcoholTypes (ID);